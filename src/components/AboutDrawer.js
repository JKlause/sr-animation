      ...
      <section className="content">
        ...
        <section className="content-body disable-scrollbars">
          ...
          <article className="paragraphs">
            ...
            <p>
              {'Hey everyone. My name is Joe. And I\'m applying to become a new member of your team. I got into coding a little over a year ago when I started attending Alchemy Code Lab. It was there that I met Megan and Anna who recommended me for this position, and whom I am grateful to! '}
            </p>
            <p>
              {'My journey to coding is a circuitous one. I started at the age of four as a classical musician. After many years of study during my adolescence, I attended the Juilliard School, the New England Conservatory of Music, and the Longy School of Music. I spent most of my time studying the trumpet, and specifically playing orchestral and chamber music. In this capacity I really developed my skill of communication: being able to freely flow ideas (both musically and verbally) as well as receiving subtle (and not so subtle) data from others.'}
            </p>
            <p>
              {'After school I started an ice cream sandwich business with my family. My father and I built it from a farmers market into a 6-store chain spanning from Florida to New Jersey. The website is PeacePieWorld.com if you are interested in having your mouth water (I didn\'t build this site). This got old though; if anyone has been in food services, you probably know what it feels like to be a cog in the machine. And after awhile, well, that just got boring to me. I still am an owner of this company, and participate in overall business decisions.'}
            </p>
            <p>
            ...
            <p>
              {'I am a member of the Eugene Symphony now, as well as the Portland Columbia Symphony. I sub with the Oregon Ballet Theatre and Portland Opera. I am also working my way onto the sublist of the Oregon Symphony, and regularly (pre-covid) get called to play a number of musicals. I also play with many chamber groups, including one of my biggest pet projects the Rose City Brass Quintet. I teach trumpet at Reed College and Clackamas Community College. I also have a number of private students out of my home (or on zoom due to covid times). If you\'re interested, you can check out these exploits at RoseCityBrassCompany.com and MusicWithJoe.com (both are square space sites so they don\'t count… and my MusicWithJoe hasn\'t been updated in a minute).'}
            </p>
            <p>
